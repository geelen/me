...
subtitle: "Or, how to persist in not learning Photoshop"
---
...
<figure name="4cec">![](https://d262ilb51hltx0.cloudfront.net/max/800/0*9q22pEjd4s_jm1vU.png)<figcaption class="image-caption">The opening slide of my presentation</figcaption></figure>
...
<figure name="da33" class="image-outset-left">![](https://d262ilb51hltx0.cloudfront.net/max/600/0*e3xBfsYk9_YJGZBy.gif)<figcaption class="image-caption">Sneakers (1999)
&lt;3: IWDRM.tumblr.com</figcaption></figure>
...
<figure name="5074">![](https://d262ilb51hltx0.cloudfront.net/max/800/0*DWd75neDN6BXoCM1.png)<figcaption class="image-caption">Timeline profile for the ‘Slow’ version.</figcaption></figure></div>
...
And then we’re done:
<figure name="abc6">![](https://d262ilb51hltx0.cloudfront.net/max/800/0*5s7eIjD8fsyl57QA.png)<figcaption class="image-caption">Timeline profile for the “fast” version</figcaption></figure>
